...
const deleteStudent = async (req, res) => {
  try {
    await pool.query("UPDATE users SET is_active=0 WHERE id=? AND role IN ('student','external')", [req.params.id]);
...
module.exports = { getAllStudents, addStudent, deleteStudent, deleteExpiredUsers, getDashboardStats, getQuickAnalytics, exportReport, exportPDF, createAdmin, getAdminList, getAnalytics };
